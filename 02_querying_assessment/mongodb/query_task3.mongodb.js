...
//
// Your thinking:
// โจทย์ต้องการรายการวัตถุดิบทั้งหมด ที่มีสต็อก ตั้งแต่ 100 ขึ้นไป อ่านโจทย์ยาวๆแล้วทำให้แอบงงตอนแรก
// แต่จริงๆแค่ดึงข้อมูลจาก ingredients แล้วกรองค่า stock_level ที่ >= 100 ใช้ $gte

// โจทย์ไม่ได้บอกว่า จะใช้โชว์ข้อมูลไหนบ้าง ก็เลยจะโชว์ทุกอย่างเลยค่ะ
