...
//
// Your thinking:
// โจทย์ต้องการหาเมนูอาหารที่มีราคาต่ำกว่า 10 เพื่อใช้ในโปรโมชั่นแบบประหยัด
// ข้อมูลที่ต้องใช้คือ ชื่อเมนูและราคาของเมนู ซึ่งอยู่ใน collection ชื่อ menu_items
// เราจะกรองข้อมูลโดยเลือกเฉพาะเมนูที่มี price น้อยกว่า 10
// ดังนั้นจะใช้ find() และใช้เงื่อนไข $lt (less than) เพื่อกรองข้อมูลตามราคา

// รอบแรกข้อมูลไม่ขึ้น เพราะลืมเขียน use("chrome-burger-db"); ค่ะ T_T
