...
--
-- Your thinking:
-- โจทย์ต้องการหาเมนูที่มีราคาน้อยกว่า 10 โดยใช้ข้อมูลจากตาราง MenuItems
-- ข้อมูลที่ต้องใช้คือชื่อเมนูและราคา ดังนั้นจะเลือกเฉพาะคอลัมน์ name และ price
-- โดยจะใช้ WHERE เพื่อกรองเฉพาะรายการที่ price น้อยกว่า 10
